...
public class IoBufferLittleEndianWriter extends GenericLittleEndianWriter {
     ...
     */
    public IoBufferLittleEndianWriter(final int size) {
        this(size, false);
    }
     ...
     */
    public IoBufferLittleEndianWriter(final int initialSize, final boolean autoExpand) {
        bb = IoBuffer.allocate(initialSize);
        bb.setAutoExpand(autoExpand);
        setByteOutputStream(new IoBufferOutputstream(bb));
    }
