...
public enum BuffStat {
    ...
    IndiePDDR(33),
    IndieCrMax(34),
    IndieBDR(35), //boss damage increase
    IndieStatR(36),
    IndieStance(37),
    ...
    IceAura(279),
    FireAura(280),
    VengeanceOfAngel(281), //righteously indignant
    HeavensDoor(282),
    Preparation(283),
    BullsEye(284),
    ...
    private BuffStat(int nValue, int nPos) {
        this.nValue = nValue;
        this.nPos = nPos;
        this.isIndie = false;
    }

    private BuffStat(int flag) {
    ...
    public static BuffStat getCTSFromTSIndex(int index) {
        switch(index) {
            case 0:
