...
public class LoginServerHandler extends IoHandlerAdapter {
    ...
    public void sessionOpened(final IoSession session) throws Exception {
        ...
        ClientSocket<LoginClient> client = new ClientSocket<>(ivRecv, ivSend, new LoginClient(session));
    ...
    public void sessionClosed(final IoSession session) throws Exception {
        ClientSocket<LoginClient> socket = (ClientSocket) session.getAttribute(ClientSocket.KEY);
        if (socket != null) {
    ...
    public void messageReceived(final IoSession session, final Object message) {
        ...
        ClientSocket<LoginClient> cs = (ClientSocket) session.getAttribute(ClientSocket.KEY);
